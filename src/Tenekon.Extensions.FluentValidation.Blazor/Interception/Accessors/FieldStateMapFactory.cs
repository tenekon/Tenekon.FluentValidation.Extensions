...
namespace Tenekon.Extensions.FluentValidation.Blazor.Interception.Accessors;

internal static class FieldStateMapFactory
{
    private const string RuntimeAssemblyName = "Tenekon.Extensions.FluentValidation.Blazor";
    private const string FieldStateMapTypeName =
        "Tenekon.Extensions.FluentValidation.Blazor.Interception.Maps.EditContextFieldStateMap`1[[Microsoft.AspNetCore.Components.Forms.FieldState, Microsoft.AspNetCore.Components.Forms]]";
